...
public class Addorganisation {
	...
	//@FindBy(xpath = "//p[normalize-space()='Centrally manage all our Organisations setup.']")
	...
	public void orgCountry() {
		...
		WebElement dropdown =wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@role='button' and @id='mui-component-select-country_id']")));
		dropdown.click();
		
		List<WebElement> orgcountries = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//li[@role='option']")));
		...
		//LinkedList <WebElement>orgcountries= (LinkedList) ldriver.findElements(By.xpath("//ul[@role='listbox']//li"));
		
		wait = new WebDriverWait(ldriver, 30);
		
		
		
		List<WebElement> orgcountries = ldriver.findElements(By.xpath("//li[@role='option']"));
				//+ "//li[@role='option']"));
	...
	public void btncreatenewOrg() throws InterruptedException {
		...
		wait = new WebDriverWait(ldriver, 30);
		WebElement createbutton = ldriver.findElement(By.xpath("//button[@title='To Create the Organization' and @type='submit']")); //button[@title='To Create the Organization']
	...
	public void alertMess() throws InterruptedException {
		...
		//((JavascriptExecutor) ldriver).executeScript("arguments[0].scrollIntoView(true);", alertElement);

		
		//By alertmess = By.xpath("(//div[@role='alert'])[1]"); //(//div[@role='alert'])[1]
	...
	public void orgCountryUpdate() {
		WebDriverWait wait = new WebDriverWait(ldriver,30);
		WebElement dropdown =wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='mui-component-select-countryValue']")));
		dropdown.click();
	...
	public void OrgUpdate(String tochangeorgname,String changeddomainname, String changedorgname, String changedregno, String changedaddress1 ) throws InterruptedException {
